	...
	SubShader
	{
		...
		Pass
		{
				...
				for (int i = 0; i < NUMBER_OF_LIGHTS_SUPPORTED; i++) {
					...
					if (local_scale_factor > zero_f) {
						...
						if (tmp_float > zero_f) {
							...
							if (tmp_float > zero_f) {
								local_color_sum += u_light_specular_color[i]
			...
			v2f vert(appdata i)
			{
                ...
                o.color = lighting_equation_textured(o.v_position_EC, o.v_normal_EC, base_color);
				return o;
			}
